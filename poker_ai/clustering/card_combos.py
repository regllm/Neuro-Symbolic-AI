...
class CardCombos:
    ...
    def __init__(
        ...
        if os.path.exists(self.card_combos_flop_path) and not os.path.exists(self.card_combos_flop_csv_path):
            ...
            with open(card_combos_flop_csv_path, "w") as f:
            ...
            self.write_info_combos(self.starting_hands, 3, card_combos_flop_csv_path)
